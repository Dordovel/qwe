...
int main (int argc, char *argv[])
{
    ...
    while(true)
    {
        ...
        std::cout<<"%Cpu: " << ((procInfo.utime - oldUse) + (procInfo.stime - oldCpu)) * 100 / (float)(cpu_time_total - oldTotal)<<"  %Mem: "<<(vmRss * page_size) / (1024 * 1024)<<std::endl;
...
int main (int argc, char *argv[])
{
    ...
    std::cout<<vmSize * page_size <<" "<< vmRss * page_size << " " << shared * page_size << " " << trs * page_size << " " << lrs * page_size << " " << drs * page_size << " " << dirtyPages * page_size<<std::endl;
